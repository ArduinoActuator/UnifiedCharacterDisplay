...
#ifdef USE_CONVERTER
#define LIQUID_CRYSTAL_PIN_RS DIGITAL_6
#define LIQUID_CRYSTAL_PIN_ES DIGITAL_7
#define LIQUID_CRYSTAL_PIN_D4 DIGITAL_4
#define LIQUID_CRYSTAL_PIN_D5 DIGITAL_5
#define LIQUID_CRYSTAL_PIN_D6 DIGITAL_2
#define LIQUID_CRYSTAL_PIN_D7 DIGITAL_3
#else /* USE_CONVERTER */
