...
#else /* USE_CONVERTER */
#define LIQUID_CRYSTAL_PIN_RS 6
#define LIQUID_CRYSTAL_PIN_ES 7
#define LIQUID_CRYSTAL_PIN_D4 4
#define LIQUID_CRYSTAL_PIN_D5 5
#define LIQUID_CRYSTAL_PIN_D6 2
#define LIQUID_CRYSTAL_PIN_D7 3
#endif /* USE_CONVERTER */
